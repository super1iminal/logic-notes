...
#### Sound (Soundness) vs Complete (Completeness)
- Soundness is the property of only being able to prove "true" things
	- e.g. something is sound if we've shown that we can prove some amount <=1.0 of the true arguments are true
	- it's still sound if we haven't shown all true things are true
	- it is not sound if we've shown that something that is false is true
- Completeness is the property of being able to prove all true things
	- e.g. something is complete if we can show that all things that should be true are true
	- it's still complete even if we show that something that is false is true
	- it's not complete if we've only shown a fraction of true things to be true
- Completeness is the water, soundness is the cap
